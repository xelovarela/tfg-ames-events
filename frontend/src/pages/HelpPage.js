...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: 'Las alertas permiten recibir avisos cuando aparezcan eventos que encajen con tus criterios guardados, si la funcionalidad está activa para tu cuenta.'
  },
  {
    icon: TriangleAlert,
